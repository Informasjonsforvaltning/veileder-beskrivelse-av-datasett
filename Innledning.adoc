...
Denne veilederen forklarer hvordan du beskriver følgende i henhold til https://data.norge.no/specification/dcat-ap-no/[DCAT-AP-NO v.2]:
...
* <<om-identifikator, Om identifikator (`dct:identifer`)>>
